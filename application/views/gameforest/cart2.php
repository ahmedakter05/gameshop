								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											...
											<?php $q = $quantity[$key]['id'];?>
											<td Style="text-align: center;"><input type="text" name="<?php echo $quantity[$key]['name'];?>" value="<?php echo $quantity[$key]['value'];?>" id="<?php echo $quantity[$key]['id'];?>" style="width:30px; text-align:center;" onchange="myFunction(this.value, <?= $key ?>)"></td><?php echo form_close();?>
...
<script>
	function myFunction(val, val2) {
	    ...
	    alert("The input value has changed. The new value is: " + val + val2);
