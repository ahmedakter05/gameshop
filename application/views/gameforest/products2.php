				...
				<div class="card-group">
					<div class="row">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
							<div class="card card-hover">
								<div class="card-img">
									<a href="<?php echo base_url() . 'games/view/' . $value['url']; ?>"><img src="<?php echo base_url() . 'assets/uploads/files/' . $value['imageurl1']; ?>" alt="<?php echo $value['name']; ?>" alt="<?php echo $value['name']; ?>"></a>
								...
								<div class="caption" style="padding: 20px 25px;">
									...
									<ul>
										...
										<li>&nbsp;|</li>
										<div class="pull-right"><li><a href="">BDT <?php echo number_format($value['price'], 2); ?></a></li></div>
									</ul>
								</div>
							</div>
						</div>
