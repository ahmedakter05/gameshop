					...
					<div class="col-md-9 col-sm-8">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="headline">
									<h4 class="no-padding-top">Checkout as a Guest<small>Or Signup please</small></h4>
								...
								<?php echo form_open("games/caguest");?>
									...
									<div class="panel-body">
										<form class="form-label">
											...
											<div class="col-lg-6 col-md-6 col-sm-6">
												...
												<div class="pull-right">
													<div class="btn-group">
	                                                	<?php echo form_submit('submit', '      ' . 'Continue' . '      ', 'class="btn btn-primary btn-icon-left" style="float: right;"');?>
	                                                </div>
												</div>
											</div>
											<?php echo form_close();?>
